...
public class FareCalculatorService {
  ...
  public void calculateFare(Ticket ticket) {
    ...
    switch (ticket.getParkingSpot().getParkingType()) {
      case CAR:
        ticket.setPrice(priceCalc(durationInMilliesec, Fare.CAR_RATE_PER_HOUR));
        break;

      case BIKE: 
        ticket.setPrice(priceCalc(durationInMilliesec, Fare.BIKE_RATE_PER_HOUR));
        break;
  ...
  private double priceCalc(long durationInMilliesec, double fareRatePerHour) {
    //Free 30-min parking:
